      ...
      <Layout>
        ...
        <section className="section_car min-h-screen pb-24 pt-24 overflow-hidden">
          <div className="container flex flex-col lg:flex-row items-center justify-center lg:justify-between">
            <div data-aos="fade-down" className="lg:w-[500px] p-8 z-10">
              <img src="https://plus.unsplash.com/premium_photo-1681489433354-f7fabdebd933?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className="w-full h-[400px] object-cover" />
            </div>
